						...
						<div class="wonderplugin-carousel-options-tab wonderplugin-carousel-options-tab-selected">
							...
							<table class="wonderplugin-form-table-noborder">
								...
								<tr>
									...
									<p><label><input name='wonderplugin-carousel-fixaspectratio' type='checkbox' id='wonderplugin-carousel-fixaspectratio'  /> Use the aspect ratio for all thumbnail images</label></p>
									</td>
								</tr>
